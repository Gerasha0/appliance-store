...
[![Version](https://img.shields.io/badge/Current_Version-0.1-blue?style=for-the-badge)](https://github.com/Gerasha0/appliance-store/releases)
...
#### 🚀 v0.1 - Major Release: Production Ready System (Latest)
- 🎨 **Полное обновление UI/UX** — современный дизайн всех страниц с темной/светлой темой
- 🌍 **Улучшенная интернационализация** — качественные переводы для всех компонентов  
- 🔐 **Надежная система авторизации** — автоматический logout при истечении токена, middleware для 401/403
- 👤 **Полноценная работа с профилем** — новый ProfileController и ProfileAPI для безопасного редактирования
- 🛒 **Умная корзина** — автоматическая очистка при logout, обработка ошибок сервера
- 📱 **Улучшенная регистрация** — селектор стран с флагами, валидация кириллицы
- 🏪 **Оптимизированный каталог** — правильные фильтры, отображение производителей, кнопки добавления в корзину
- 📦 **Исправленная система заказов** — автоматический расчет стоимости, правильные связи в БД
- 🛡️ **Безопасность и производительность** — условные API запросы, проверка прав доступа
...
- ✅ **Улучшенная работа с паролями** — обязательный при создании, опциональный при редактировании
