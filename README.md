...
[![Version](https://img.shields.io/badge/Current_Version-0.3-blue?style=for-the-badge)](https://github.com/Gerasha0/appliance-store/releases)
...
#### 🛠️ v0.3 - Stability & Performance Release (Latest)
- 🔧 **Критические исправления UI** — устранена проблема "Виробник N/A" в диалогах деталей
- 🎛️ **Улучшенное переключение режимов** — исправлены ошибки при переходе между режимами "список"/"эскизы"
- 🚫 **Устранение aria-hidden предупреждений** — добавлен `disableRestoreFocus` для корректного закрытия диалогов
- 📦 **Решение проблем сериализации** — добавлены `@JsonIgnoreProperties` для предотвращения циклических ссылок
- 💥 **Исправление StackOverflowError** — заменена аннотация `@Data` на специфичные Lombok аннотации
- 📊 **Корректная система заказов** — исправлено исчезновение товаров при редактировании заказов
- 📝 **Расширенное логирование** — добавлено детальное логирование в AuthController, JWT компоненты
- 🗄️ **MySQL интеграция** — добавлена поддержка MySQL с Flyway миграциями
- ⚡ **Оптимизация производительности** — устранены проблемы с JPA orphanRemoval и состоянием сущностей
